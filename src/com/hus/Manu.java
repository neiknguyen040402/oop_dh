...
public class Manu {
    ...
    public static void printManu() {
        System.out.println("=======================");
        System.out.println("| MANU SELECTION DEMO |");
        System.out.println("|---------------------|");
    ...
    public static void selectLab1(int choice, String[] args) {
    ...
    public static void selectLab2(int choice, String[] args) {
        switch (choice) {
            case 1:
    ...
    public static void selectLab6(int choice, String[] args) {
        switch (choice) {
            case 1:
                System.out.println("1. The Discount System");
    ...
    public static void selectHomework1(int choice, String[] args) {
        switch (choice) {
            case 1:
    ...
    public static void selectHomework2(int choice, String[] args) {
        switch (choice) {
            case 1:
    ...
    public static void selectHomework3(int choice, String[] args) {
        switch (choice) {
            case 1:
    ...
    public static void selectHomework4(int choice, String[] args) {
        switch (choice) {
            case 1:
    ...
    public static void selectHomework5(int choice, String[] args) {
        switch (choice) {
            case 1:
    ...
    public static void selectHomework6(int choice, String[] args) {
        switch (choice) {
            case 1:
